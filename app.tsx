// bb-plugin-tinkerer — a BB plugin frontend entry.
//
...
function useTodos() {
  ...
  // or `bb tinkerer add` run by an agent — so the list never goes stale.
    ...
    <div className="h-full min-h-0 flex-1 overflow-y-auto">
      <div className="mx-auto box-border w-full max-w-3xl px-4 pb-4 pt-3 md:px-5 md:pt-4">
        <p className="text-sm text-muted-foreground">
          Agents keep this list with <code>bb tinkerer</code>; the skill in{" "}
        ...
        <div className="mt-4">
          {todos === null ? (
            ...
            <EmptyState>
              ...
              <code>bb tinkerer add "Ship it"</code>.
            </EmptyState>
          ) : (
...
export default definePluginApp((app) => {
  app.slots.navPanel({
    ...
    title: "Example todos",
    icon: "ListTodo",
    // Routed at /plugins/tinkerer/example-todos; the component receives the
